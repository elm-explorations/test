module EffectivenessSUT.Bst3 exposing (delete, fromList, insert, keys, member, toList, union)
...
{-| BUG: When the key already exists, we return the tree unchanged
    ...
    case tree of
        ...
        Node left key val right ->
            if k < key then
                ...
                -- BUG: key exists, but we return tree unchanged instead of updating
                tree
