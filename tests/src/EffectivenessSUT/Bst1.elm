module EffectivenessSUT.Bst1 exposing (delete, fromList, insert, keys, member, toList, union)
...
{-| BUG: Always returns a fresh single-node tree, discarding the existing tree.
-}
